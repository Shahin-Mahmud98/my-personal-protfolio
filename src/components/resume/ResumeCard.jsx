...
const ResumeCard = ({title,subTitle,result,des}) => {
    return (
        ...
        <div className="flex justify-between items-center gap-4 ">
          ...
          <div>
            <p className="w-20 h-10 px-4 py-2 text-designColor bg-black bg-opacity-25 rounded-lg flex justify-center items-center shadow-shadowOne text-sm font-medium">
              {result}
            </p>
          </div>
        </div>
